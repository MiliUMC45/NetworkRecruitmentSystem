...
<div id="main">
    <div class="register-frame">
        ...
        <form class="register-form" id = "form" action="RegisterPersonnelServlet">
            ...
            公司ID：<select class="companyIDselect" name="CompanyID" id="CompanyID">
                        <option value="1">七星娱乐</option>
                        <option value="2">米哈游</option>
                        <option value="3">华为</option>
                        <option value="4">太平洋房屋</option>
                        <option value="5">行动教育</option>
                        <option value="6">星巴克咖啡</option>
                    </select>
